        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CPRNumber = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    PatientReferenceNumber = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LeavePeriods_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_CPRNumber",
                table: "AspNetUsers",
                column: "CPRNumber",
                unique: true,
                filter: "[CPRNumber] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_PatientReferenceNumber",
                table: "AspNetUsers",
                column: "PatientReferenceNumber",
                unique: true,
                filter: "[PatientReferenceNumber] IS NOT NULL");
